 ...
 * @extends design
 **/
org.uizard.core.design.canvas.objectexplorer = function () {
	/**
...
org.uizard.core.design.canvas.objectexplorer.prototype = {
	...
	refresh: function () {
		...
		$(self.parent.objects).each(function (i) {
		    var titleNode = new YAHOO.widget.TextNode("objectInformation"+i, root, true);
