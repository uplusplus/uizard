...
org.uizard.core.design.android = function () {
	/**
	 * 
	 * @property name
	 * @type String
	 * @default "design.android"
	 **/
	this.name = "design.android";
	
	/**
	 * 
	 * @property stencilCSS
	 **/
	this.stencilCSS = "org.uizard.stencil.android/stencil.android.css";
...
org.uizard.core.design.android.prototype = {
	...
	addProjectItem: function () {
		...
		$("div[id='projectNew']").find(".projectTypes").append("<div class='projectWizardFirstButton' project-type='androidp' style='height:40px; padding:8px; border-bottom:1px solid #ccc; cursor:pointer;'><img src='plugins/org.uizard.core.design.uml/image/icon_classDiagram.png' style='width:40px; height:40px; vertical-align:middle; margin-bottom:3px;' /><span style='margin-left:5px;'>Android Projects</span></div>");
		
		$("div[id='projectNew']").find(".projectItems").append("<div class='projectWizardSecondButton all androidp' style='float:left; width:70px; height:70px; margin:5px; cursor:pointer;' description='  Android 2.3 Application을 위한 프로젝트를 생성합니다.' projecttype='android'><img src='plugins/org.uizard.core.design.uml/image/icon_classDiagram.png' style='width:40px; height:40px; vertical-align:middle; margin-bottom:3px;' /><br /><a>Android 2.3</a></div>");
		$("div[id='projectNew']").find(".projectItems").append("<div class='projectWizardSecondButton all androidp' style='float:left; width:70px; height:70px; margin:5px; cursor:pointer;' description='  Android 2.2 Application을 위한 프로젝트를 생성합니다.' projecttype='android'><img src='plugins/org.uizard.core.design.uml/image/icon_stateDiagram.png' style='width:40px; height:40px; vertical-align:middle; margin-bottom:3px;' /><br /><a>Android 2.2</a></div>");
		$("div[id='projectNew']").find(".projectItems").append("<div class='projectWizardSecondButton all androidp' style='float:left; width:70px; height:70px; margin:5px; cursor:pointer;' description='  Android 2.1 Application을 위한 프로젝트를 생성합니다.' projecttype='android'><img src='plugins/org.uizard.core.design.uml/image/icon_sequenceDiagram.png' style='width:40px; height:40px; vertical-align:middle; margin-bottom:3px;' /><br /><a>Android 2.1</a></div>");	
	...
	addToolBox: function () {
		...
		$("#toolBox").append("<div id='toolAndroid_title' class='toolTitle'>Android UI Objects</div>");
		...
		//Button
		$("#toolBox").append("<a href='#' action='addAndroidUIObject_button'><div id='toolAndroid_UIObject_button' class='toolItem itemIconSquare'>Button</div></a>");
		
		// Radio Burron
		$("#toolBox").append("<a href='#' action='addAndroidUIObject_radioButton'><div id='toolAndroid_UIObject_radioButton' class='toolItem itemIconSquare'>Radio Button</div></a>");
		
		// Label
		$("#toolBox").append("<a href='#' action='addAndroidUIObject_label'><div id='toolAndroid_UIObject_label' class='toolItem itemIconSquare'>Label</div></a>");
		
		// Check Box
		$("#toolBox").append("<a href='#' action='addAndroidUIObject_checkBox'><div id='toolAndroid_UIObject_checkBox' class='toolItem itemIconSquare'>Check Box</div></a>");
		...
		*/
		...
		// Add Fuctions
		// Button
		$("a[action=addAndroidUIObject_button]").click(function () {
			var shapeAdapter = "org.uizard.stencil.android/uiobject.button";
			...
			if (self.windowManager.window[self.windowManager.activeWindow].designer) {
				...
				m.er("Active window does not have a desginer!", "plugin: design.android");
			}
		});	
		
		
		// Radio Button
		$("a[action=addAndroidUIObject_radioButton]").click(function () {
			var shapeAdapter = "org.uizard.stencil.android/uiobject.radioButton";
		...
		// Label
		$("a[action=addAndroidUIObject_label]").click(function () {
			var shapeAdapter = "org.uizard.stencil.android/uiobject.label";
		...
		// Check Box
		$("a[action=addAndroidUIObject_checkBox]").click(function () {
			var shapeAdapter = "org.uizard.stencil.android/uiobject.checkBox";
